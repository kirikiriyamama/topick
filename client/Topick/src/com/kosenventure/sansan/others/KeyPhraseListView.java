...
//		deleteData();
	...
	private void saveData(){
		mAd.writeDb(getStr(R.string.keyphrase_table), "çÇêÍ", "2009-08-24 23:10:15");
		mAd.writeDb(getStr(R.string.cancel_keyphrase_table), "ètãxÇ›", "2009-08-24 23:10:15");	
		mAd.writeDb(getStr(R.string.keyphrase_table), "çÇêÍ", "2009-08-24 23:10:15");
		mAd.writeDb(getStr(R.string.cancel_keyphrase_table), "ètãxÇ›", "2009-08-24 23:10:15");	
		mAd.writeDb(getStr(R.string.keyphrase_table), "çÇêÍ", "2009-08-24 23:10:15");
		mAd.writeDb(getStr(R.string.cancel_keyphrase_table), "ètãxÇ›", "2009-08-24 23:10:15");	
...
//				keyphraseLineView.removeView(keyphraseView);
	...
	private void sortKeyPhrases(){
	    ...
	    for (int i = 1; i < count; i++) {
	    	...
	    	// â°ïùÇí¥Ç¶Ç»Ç¢Ç»ÇÁëOÇÃÉ{É^ÉìÇÃâEÇ…èoÇ∑
